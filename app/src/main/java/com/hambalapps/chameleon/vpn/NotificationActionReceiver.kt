...
class NotificationActionReceiver : BroadcastReceiver() {
    companion object {
        const val ACTION_PREV_NODE = "com.hambalapps.chameleon.vpn.ACTION_PREV_NODE"
        const val ACTION_NEXT_NODE = "com.hambalapps.chameleon.vpn.ACTION_NEXT_NODE"
    }
        ...
        if (action == ACTION_PREV_NODE || action == ACTION_NEXT_NODE) {
            ...
            CoroutineScope(Dispatchers.IO).launch {
                try {
                    ...
                    android.util.Log.e("Chameleon", "Failed to cycle node: ${e.message}")
                } finally {
