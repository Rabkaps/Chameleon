package com.example.expressivebox.vpn
...
import com.example.expressivebox.MainActivity
...
class VpnServiceWrapper : VpnService(), PlatformInterface, CommandServerHandler {
    ...
    companion object {
        const val ACTION_START = "com.example.expressivebox.START"
        const val ACTION_STOP = "com.example.expressivebox.STOP"
    ...
    private fun startForegroundServiceNotification() {
        android.util.Log.i("ExpressiveBox", "startForegroundServiceNotification called")
        ...
        val notification = NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .setContentText("Bypassing censorship securely...")
            .setSmallIcon(android.R.drawable.ic_dialog_info)
            .setContentIntent(pendingIntent)
            .setPriority(NotificationCompat.PRIORITY_LOW)
            .build()

        android.util.Log.i("ExpressiveBox", "Calling startForeground with ID $NOTIFICATION_ID")
