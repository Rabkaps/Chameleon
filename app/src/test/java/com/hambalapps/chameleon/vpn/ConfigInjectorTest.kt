...
class ConfigInjectorTest {
    ...
    fun testAiBypassConfigInjection() {
        ...
        assert(endpoint.getJSONArray("addresses").getString(0) == "172.16.0.2/32")
    ...
    fun testAmneziaWGParsing() {
        ...
        val localAddresses = proxyOutbound.getJSONArray("addresses")
    ...
    fun testRawWireGuardConfParsing() {
        ...
        val localAddress = outbound.getJSONArray("addresses")
