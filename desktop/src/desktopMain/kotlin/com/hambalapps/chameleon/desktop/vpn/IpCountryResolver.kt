...
object IpCountryResolver {
    private val cacheFile = File(System.getProperty("user.home"), ".chameleon/ip_countries_cache.json")
...
fun getFlagEmoji(serverName: String, countryCode: String? = null): String {
    ...
    return when {
        ...
        name.contains("united states") || name.contains("new york") || name.contains("chicago") || name.contains("los angeles") || hasCountryToken("us") -> "🇺🇸"
