        ...
        if (isDark) {
            if (cardStyle == "vibrant") {
                baseScheme.copy(
                    ...
                    primaryContainer = tintColor(Color.Black, baseScheme.primary, ratio = 0.35f),
                    onPrimaryContainer = tintColor(Color.White, baseScheme.primary, ratio = 0.90f),
                    secondaryContainer = tintColor(Color.Black, baseScheme.secondary, ratio = 0.35f),
                    onSecondaryContainer = tintColor(Color.White, baseScheme.secondary, ratio = 0.90f),
                    tertiaryContainer = tintColor(Color.Black, baseScheme.tertiary, ratio = 0.35f),
